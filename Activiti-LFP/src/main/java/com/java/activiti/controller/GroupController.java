...
public class GroupController {
		...
		public String existGroupName(HttpServletResponse response,@RequestParam(value = "groupName", required = true) String groupName) throws Exception{
			List<Group> groupList=groupService.findGroupById(groupName);
